...
/*
 *    $RCSfile: parser_backup_before201111.cpp,v $
 *    $Revision: 1.1 $
...
void stamp_sub(const char* filename, int nL, int nIS, int nVS, int& nNodes, double& tstep, double& tstop, Source *VS, Source *IS, matrix* G, matrix* C, matrix* B, NodeList* nodePool)
{
  char* strline;
  char* node1, *node2;
